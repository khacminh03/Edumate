            ...
            <div class="forms-container">
                <div class="signin-signup">
                    <form action="signupTutorAction.php" class="signup-form" method="post">
                        ...
                        <input type="submit" id="contract" onclick="window.location.href='contract.pdf';" value="Hiện thông tin hợp đồng">
                        <input type="submit" id="submit" onclick="window.location.href='signuptecf.html';" value="Đăng ký thông tin gia sư">
                        <div class="hrline">
                            HOẶC
                        </div>
                        <div>
