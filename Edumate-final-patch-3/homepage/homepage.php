...
<body>
 ...
 <div class="container_1">
    <div class="text-box_1">
      ...
      <br />
      <div>
        <button oonclick="window.location.href='./login/login.html';">
  ...
  <div class="container_2">
    <div class="text-box_2">
      ...
      <br />
      <div>
        <button style="background-color: #2e7ef5" onclick="window.location.href='./login/login.html';">Đăng ký chọn gia sư ngay</button>
      </div>
    </div>
  </div>
  ...
  <div class="button_register" style="
        ...
        padding-bottom: 20px;
      ">
    <button style="background-color: #2e7ef5" onclick="window.location.href='./login/login.html';">
      Đăng ký chọn gia sư ngay
    </button>
  </div>
