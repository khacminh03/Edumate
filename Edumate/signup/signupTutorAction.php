<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        $username = $_POST["tefullname"];
        $email = $_POST["teemail"];
        $telephone = $_POST["tephonenumber"];
        $password = password_hash($_POST["tepassword"], PASSWORD_DEFAULT);
        $userId = "TE" . "-" . md5($username);
        ...
        if (!$sql->execute()) {
            ...
            header("Location: signupTutorCf.html");
        }
    }
?>
