...
<head>
    ...
    <style>
        ...
        .stars .inactive {
            color: #ddd; /* Color for inactive stars */
        }
        .btn-book-now {
            margin-top: 20px;
...
<body>
    ...
    <div class="container mt-4 detail-teacher">
        ...
        <button class="btn btn-primary btn-book-now">Thuê ngay</button>
    </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-4VRCP9F/M9sQ9gJxqQ7fU3OlhJ3S3W2a8zOg0a8eI4VqP+Jq6U4VdxKPzAKsK7lA" crossorigin="anonymous"></script>
</body>
</html>
